		...
		public static void main (String [] args) {		
			...
			String user = System.getProperty("user.home");
				...
				try {
					...
					else {fileReader = new FileReader(user+"\\qthres\\qth.txt");};
	...
	if (args[0].equals("help")==false && args.length>1) {
		...
		if (valid.contains("page") && args.length==2) {
			...
			try {
				...
				else {p = Runtime.getRuntime().exec("C:\\/Program Files/\\/Mozilla Firefox/\\firefox.exe https://www.qrzcq.com/call/"+args[0]);};
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		if (valid.contains("map")) {
			...
			try {
				...
				else {p = Runtime.getRuntime().exec("C:\\/Program Files/\\/Mozilla Firefox/\\firefox.exe https://www.luftlinie.org/"+line+"/"+coordinates);};
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
