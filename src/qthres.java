...
public class qthres {
	...
	public static void main(String[] args) {
		...
		if (args[0].equals("help") && args.length == 1) {
			...
			System.out.println("qrzcq: Open the webpage (qrzcq.com) of the callsign");
			System.out.println("qrz: Open the webpage (qrz.com) of the callsign");
			...
			if (args[0].contains(",")) {
				...
				if (args[0].equals("help") == false && args.length > 1) {
					...
					if (valid.contains("swap")) {
						...
						if (valid.contains("qrzcq") && args.length == 2) {
						...
						if (valid.contains("qrz") && args.length == 2) {
							...
							try {
								if (user.contains("/home")) {
									p = Runtime.getRuntime().exec("firefox https://www.qrz.com/db/" + args[0]);
								} else {
									p = Runtime.getRuntime().exec(
											"C:\\/Program Files/\\/Mozilla Firefox/\\firefox.exe https://www.qrzcq.com/call/"
													+ args[0]);
